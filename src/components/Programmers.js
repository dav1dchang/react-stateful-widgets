...
export default function Programmers() {
  ...
  const programmersName = programmers.filter((programmer) => programmer.id === selectedProgrammer)
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: (selectedProgrammer === null ? 'royalblue' : 'gold'), // 🤔 color turns to gold, when celebrating
  };
